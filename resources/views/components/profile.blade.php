    ...
    <div class="card d-flex flex-column h-100">
        ...
        <div class="card-body align-self-stretch">
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control form-control-sm" id="profile-name" placeholder="text">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-3">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="file" class="form-control-file" id="profile-avater">
                    <!--
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" id="profile-avater">
