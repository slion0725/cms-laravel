  ...
  methods: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_10_vuex__["mapActions"])("datatables", ["search_emit", "search_clear"]), {
    edit_onSubmit: function edit_onSubmit(scope) {
      ...
      this.$validator.validateAll(scope).then(function (result) {
        ...
        __WEBPACK_IMPORTED_MODULE_5_axios___default.a.post("assign-roles/" + _this.edit.id, _this.edit).then(function (response) {
          ...
          _this.edit = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.cloneDeep(data.edit);
